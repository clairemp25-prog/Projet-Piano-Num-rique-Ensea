...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : LD2_Pin STEPPER_DIR_Pin LED_2_Pin STEPPER_MS1_Pin
                           STEPPER_ENN_Pin */
  ...
  /*Configure GPIO pins : touche_1_Pin touche_2_Pin touche_3_Pin touche_6_Pin
                           touche_7_Pin touche_8_Pin touche_9_Pin touche_4_Pin
                           touche_5_Pin */
  GPIO_InitStruct.Pin = touche_1_Pin|touche_2_Pin|touche_3_Pin|touche_6_Pin
                          |touche_7_Pin|touche_8_Pin|touche_9_Pin|touche_4_Pin
                          |touche_5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
